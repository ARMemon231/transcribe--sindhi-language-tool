...
export const Uploader: React.FC<UploaderProps> = ({ onUpload, isLoading }) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <h3 className="text-xl font-semibold text-slate-800">Upload Sindhi Paper Image</h3>
        <p className="text-slate-500 mt-1">Drag & drop your scanned image or handwritten photo</p>
      </div>
        ...
        <div className="absolute inset-0 bg-white/80 backdrop-blur-sm rounded-2xl flex flex-col items-center justify-center z-10">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="space-y-1">
              <p className="font-bold text-blue-600">Recognizing Sindhi Script...</p>
              <p className="text-sm text-slate-500">Transcribing handwriting & converting to digital format</p>
            </div>
          </div>
        </div>
      )}
